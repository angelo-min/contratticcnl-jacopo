...
const macrosettoriConfig: Record<string, { nome: string; icona: string; descrizione: string }> = {
  A: { nome: 'Agricoltura', icona: '🌾', descrizione: 'Contratti del settore agricolo e florovivaistico' },
  B: { nome: 'Chimici', icona: '⚗️', descrizione: 'Industria chimica, farmaceutica, energia e petrolio' },
  C: { nome: 'Meccanici', icona: '🔧', descrizione: 'Industria metalmeccanica e siderurgica' },
  D: { nome: 'Tessili', icona: '🧵', descrizione: 'Industria tessile, abbigliamento e moda' },
  E: { nome: 'Alimentaristi', icona: '🍞', descrizione: 'Industria alimentare e delle bevande' },
  F: { nome: 'Edilizia, Legno e Arredamento', icona: '🏗️', descrizione: 'Costruzioni, legno e arredamento' },
  G: { nome: 'Poligrafici e Spettacolo', icona: '🎭', descrizione: 'Editoria, grafica, spettacolo e comunicazione' },
  H: { nome: 'Terziario e Servizi', icona: '🛒', descrizione: 'Commercio, turismo, vigilanza e studi professionali' },
  I: { nome: 'Lavoro Domestico', icona: '🏠', descrizione: 'Colf, badanti e collaboratori domestici' },
  L: { nome: 'Trasporti', icona: '🚌', descrizione: 'Trasporto merci e persone, logistica' },
  M: { nome: 'Credito e Assicurazioni', icona: '🏦', descrizione: 'Banche, istituti di credito e assicurazioni' },
  N: { nome: 'Aziende di Servizi', icona: '⚡', descrizione: 'Elettrico, telecomunicazioni, multiservizi' },
  O: { nome: 'Istruzione, Sanità, Assistenza', icona: '🏥', descrizione: 'Istruzione privata, sanità e assistenza sociale' },
  P: { nome: 'Plurisettoriali', icona: '📦', descrizione: 'Contratti trasversali e plurisettoriali' },
  Q: { nome: 'Funzioni Centrali (PA)', icona: '🏛️', descrizione: 'Pubblica amministrazione centrale' },
  R: { nome: 'Funzioni Locali (PA)', icona: '🏛️', descrizione: 'Pubblica amministrazione locale' },
  S: { nome: 'Sanità Pubblica', icona: '🏥', descrizione: 'Servizio sanitario nazionale' },
  T: { nome: 'Scuola Pubblica', icona: '🎓', descrizione: 'Istruzione pubblica' },
}
